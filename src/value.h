...
// void iniStackValue(dataType  type, int index);
...
void insertDataToValue(struct Token* token , Value* value);
 Value* pushRuntimeStackCloneValue(Value* value);
 void copyValue(Value* from , Value* to);
 Value* pushRuntimeStackValue(dataType type );
 Value* iniStackMemoryValue(int index , dataType type);